...
public class RandomNumber {
    ...
    public ArrayList myNumbers() {
        ...
        do {
            ...
            Integer random_number = rd.nextInt(8) + 1;
            switch (random_number) {
                case 1:
                    if (duplicates.contains("4") && duplicate_for_number_1 == 2) {
                        break;
                    }
                    ...
                    break;
                case 2:
                    if (duplicates.contains("4") && duplicate_for_number_2 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 3:
                    if (duplicates.contains("4") && duplicate_for_number_3 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 4:
                    if (duplicates.contains("4") && duplicate_for_number_4 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 5:
                    if (duplicates.contains("4") && duplicate_for_number_5 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 6:
                    if (duplicates.contains("4") && duplicate_for_number_6 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 7:
                    if (duplicates.contains("4") && duplicate_for_number_7 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 8:
                    if (duplicates.contains("4") && duplicate_for_number_8 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ...
                    break;
                case 9:
                    if (duplicates.contains("4") && duplicate_for_number_9 == 2) {
                        break;
                    }
                    numbers.add(random_number);
                    ;
